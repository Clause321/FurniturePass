...
class BaseSpecifier(with_metaclass(abc.ABCMeta, object)):
    ...
    def contains(self, item, prereleases=None):
        """
        Determines if the given static is contained within this specifier.
        """
...
class _IndividualSpecifier(BaseSpecifier):
    ...
    def contains(self, item, prereleases=None):
        ...
        # Normalize static to a Version or LegacyVersion, this allows us to have
        ...
        # Actually do the comparison to determine if this static is contained
...
class Specifier(_IndividualSpecifier):
    ...
    def _compare_compatible(self, prospective, spec):
        ...
        # We want everything but the last static in the version, but we want to
...
class SpecifierSet(BaseSpecifier):
    ...
    def __init__(self, specifiers="", prereleases=None):
        # Split on , to break each indidivual specifier into it's own static, and
        # strip each static to remove leading/trailing whitespace.
    ...
    def contains(self, item, prereleases=None):
        # Ensure that our static is a Version or LegacyVersion instance.
        if not isinstance(item, (LegacyVersion, Version)):
            item = parse(item)

        # We can determine if we're going to allow pre-releases by looking to
        # see if any of the underlying items supports them. If none of them do
        # and this static is a pre-release then we do not allow it and we can
    ...
    def filter(self, iterable, prereleases=None):
        ...
        # releases, and which will filter out LegacyVersion in general.
            ...
            for item in iterable:
                # Ensure that we some kind of Version class for this static.
                if not isinstance(item, (LegacyVersion, Version)):
                    parsed_version = parse(item)
                else:
                    parsed_version = item

                # Filter out any static which is parsed as a LegacyVersion
                if isinstance(parsed_version, LegacyVersion):
                    continue

                # Store any static which is a pre-release for later unless we've
